        ...
        <div className="glass-panel" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', margin: 0, lineHeight: '1.4' }}>
              Hone your technical precision and verbal fluency under real-world pressure. Select a track or compile bespoke interview questions derived directly from your matched jobs.
            </p>
          </div>
          ...
          <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.08)', paddingTop: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.85rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ fontSize: '0.85rem', fontWeight: 800, color: 'var(--primary)' }}>💼 Job-Specific Bespoke AI Interview</span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', background: 'rgba(255,255,255,0.01)', padding: '1rem', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.03)', transform: 'translateY(0)', transition: 'all 0.3s ease' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'flex-end' }}>
                  <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
                    <span style={{ fontSize: '0.65rem', color: 'var(--text-muted)', fontWeight: 800 }}>JOB STYLE / ARRANGEMENT</span>
                    <select
                      ...
                      style={{ padding: '0.55rem', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '6px', color: '#fff', fontSize: '0.8rem', outline: 'none' }}
                    >
                      <option value="Remote">Remote (Full Self-Direction & Async Depth)</option>
                      <option value="Hybrid">Hybrid (Schedules Co-ordination & Flex Work)</option>
                      <option value="Onsite">On-Site (Physical Synergy & On-site Collaboration)</option>
                    </select>
                  </div>
                  <button
                    className="btn-glass btn-primary"
          ...
          <div className="glass-panel" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.25rem', border: '1px solid rgba(138, 92, 246, 0.2)' }}>
              ...
              <div style={{ border: '1px solid rgba(255,255,255,0.06)', borderRadius: '8px', background: 'rgba(255,255,255,0.01)', overflow: 'hidden' }}>
                ...
                >
                  <span style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                    💡 View Preparation Guidance & Keywords
                  </span>
                  ...
                  <div style={{ padding: '1rem', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', flexDirection: 'column', gap: '0.75rem', background: 'rgba(0,0,0,0.2)' }}>
                    {questionsList[activeQuestionIndex]?.focusArea && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
                        <span style={{ fontSize: '0.65rem', fontWeight: 800, color: 'var(--primary)', textTransform: 'uppercase' }}>Focus Area</span>
                    ...
                    {questionsList[activeQuestionIndex]?.keyPoints && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
                        <span style={{ fontSize: '0.65rem', fontWeight: 800, color: 'var(--emerald)', textTransform: 'uppercase' }}>Suggested Key Terms to Mention</span>
                    ...
                    {questionsList[activeQuestionIndex]?.communicationGuidance && (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
                        <span style={{ fontSize: '0.65rem', fontWeight: 800, color: '#f59e0b', textTransform: 'uppercase' }}>Tone & Delivery Guide</span>
            ...
            <div style={{ background: 'rgba(0,0,0,0.4)', borderRadius: '8px', padding: '1rem', border: '1px solid rgba(255,255,255,0.04)', minHeight: '100px', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              <p style={{ fontSize: '0.8rem', color: 'var(--text-primary)', margin: 0, flex: 1, fontStyle: verbalTranscript ? 'normal' : 'italic' }}>
                {verbalTranscript || (isRecording ? 'Listening to voice... Start speaking your answer.' : 'No verbal recording captured yet. Tap record or use domain fallbacks.')}
              </p>
            </div>
            ...
            <div style={{ display: 'flex', gap: '1rem', marginTop: '0.5rem' }}>
              ...
              >
                {isRecording ? '🔴 Stop Capturing' : '🎙️ Tap to Record Voice'}
              </button>
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        {scorecard ? (
          <div className="glass-panel" style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.5rem', border: '1px solid rgba(16, 185, 129, 0.2)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1rem', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.4rem' }}>
                ...
                <span style={{ fontSize: '0.65rem', fontWeight: 800, color: 'var(--text-secondary)' }}>DEPTH</span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.4rem' }}>
                ...
                <span style={{ fontSize: '0.65rem', fontWeight: 800, color: 'var(--text-secondary)' }}>VOCAL</span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.4rem' }}>
                ...
                <span style={{ fontSize: '0.65rem', fontWeight: 800, color: 'var(--text-secondary)' }}>ATS FIT</span>
              </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', background: 'rgba(255,255,255,0.02)', padding: '1rem', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.04)' }}>
              <span style={{ fontSize: '0.75rem', fontWeight: 800, color: 'var(--primary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                🎓 Expert STAR Model Answer Reference
              </span>
          ...
          <div className="glass-panel" style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '300px', color: 'var(--text-muted)', padding: '2rem', textAlign: 'center', gap: '1rem' }}>
            ...
            <div>
              <h4 style={{ color: 'var(--text-primary)', margin: '0 0 0.25rem 0' }}>Evaluation Panel Ready</h4>
              <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', margin: 0, maxWidth: '280px', lineHeight: 1.4 }}>
                Select a domain track, tap record to articulate your solution, and click analyze to output detailed neural grades.
              </p>
            </div>
          </div>
        )}

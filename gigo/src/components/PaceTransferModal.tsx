      ...
      <div className="modal-content animate-fade-in" style={{ maxWidth: '440px', width: '95%' }}>
        ...
        {success ? (
          <div style={{ textAlign: 'center', padding: '0.5rem 0' }}>
            ...
            <h3 style={{ fontSize: '1.1rem', fontWeight: 800, color: '#fff', margin: '0 0 0.5rem 0' }}>Pace Sent</h3>
          ...
          <>
            <h3 style={{ fontSize: '1.2rem', fontWeight: 800, marginBottom: '0.5rem', color: '#fff' }}>↗️ Send Pace</h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1rem' }}>
              <input
                ...
                style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid var(--border-glass)', borderRadius: '10px', padding: '0.75rem', fontSize: '0.85rem', color: '#fff' }}
              />
              <input
                type="number"
                min="1"
